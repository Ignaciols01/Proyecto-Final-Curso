    ...
    <div className="p-4 md:p-8 bg-gray-50 dark:bg-[#0f172a] min-h-screen transition-colors duration-300">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full xl:w-auto">
          ...
          <button onClick={() => setShowModal(true)} className="flex-1 sm:flex-none justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition-all cursor-pointer">
            + CREAR TURNO
          </button>
        </div>
      </div>
